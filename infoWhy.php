...
?>
    ...
    It can even do solo events like cutting!
    ...
    <span style="unicode-bidi:bidi-override; direction: rtl; text-decoration:underline">ac.nilknarfnaes@ameh</span>
    ...
    <p>
        ...
        or even crazy one hit tournaments with several rounds of pools. The program was designed to be as versatile
    ...
    <p>
        ...
        <BR>
        This also means that you don't have to take the time to print pool results and make brackets for people to
        follow.
        Why? Because it's right there at their fingertips, with no effort on your part. <BR>
        <em>(Yes, <a href='http://hemaratings.com/'>HEMA Ratings</a> can also grab your results directly, without you
            needing to send them in.)</em>
    </p>
